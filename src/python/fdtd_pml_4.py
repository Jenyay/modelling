...
Слева - PEC.
Справа - поглощающий полностью согласованный слой с плавным увеличением потерь.
'''
...
if __name__ == '__main__':
    ...
    layer_loss_start = 160
    layer_loss_1 = 0.0
    layer_loss_2 = 0.025

    # layer_loss_start = 190
    # layer_loss_1 = 0.05
    # layer_loss_2 = 0.05
    ...
    layer_loss_end = maxSize
    loss[layer_loss_start:] = (np.arange(layer_loss_start, layer_loss_end) - layer_loss_start) * (layer_loss_2 - layer_loss_1) / (layer_loss_end - layer_loss_start) + layer_loss_1
    # print(loss)
    ...
    ceze[layer_loss_start] = (ceze[layer_loss_start - 1] + ceze[layer_loss_start + 1]) / 2
    cezh[layer_loss_start] = (cezh[layer_loss_start - 1] + cezh[layer_loss_start + 1]) / 2
    ...
    display.drawBoundary(layer_loss_start)
